...
const paginate = require('universal-pattern/libs/paginate');
const services = require('universal-pattern/services');
const controllers = require('universal-pattern/controllers');
const swaggerMetadata = require('universal-pattern/libs/swagger-metadata');
const swaggerRouter = require('universal-pattern/libs/swagger-router');
